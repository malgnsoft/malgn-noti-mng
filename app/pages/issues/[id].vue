<template>
  <div class="page">
    ...
    <article v-else class="issue">
      ...
      <section v-if="isAuthor" class="owner-bar">
        ...
        <div class="owner-actions">
          <NuxtLink :to="`/issues/${issue.id}/edit`" class="act">수정</NuxtLink>
          <button type="button" class="act danger" :disabled="busy" @click="onDelete">삭제</button>
        </div>
      </section>
